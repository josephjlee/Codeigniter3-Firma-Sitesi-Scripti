<div class="breadcrumb-area shadow dark bg-fixed text-center text-light"
     style="background-image: url(<?php echo base_url("assets"); ?>/img/banner/22.jpg);">
    <div class="container">
        <div class="row">
                ...
                <div class="col-md-12 portfolio-content">
                    ...
                    <div class="row magnific-mix-gallery text-center masonary">
                        <div id="portfolio-grid" class="portfolio-items col-4"
                             style="position: relative; height: 585.656px;">
                            <!-- Single Item -->
                            <?php foreach ($galleries as $gallery) { ?>
                                <div class="pf-item development capital"
                                     style="position: absolute; left: 0%; top: 0px;">
                                    <div class="effect-left-swipe">
                                        <img src="<?php echo get_picture("galleries_v/images/$gallery->folder_name", get_gallery_cover_image($gallery->folder_name), "350x216"); ?>"
                                             alt="thumb">
                                        <div class="icons">
                                            <h4>
                                                <a href="<?php echo base_url("fotograf-galerisi/$gallery->url"); ?>"><?php echo $gallery->title; ?></a>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
