...
<header class="app-header"><a class="app-header__logo" href="index.html"><?php echo $settings->company_name; ?></a>
    ...
    <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i
            ...
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
                <li><a class="dropdown-item" href="<?php echo base_url("settings"); ?>"><i class="fa fa-cog fa-lg"></i>
                        Ayarlar</a></li>
                <li><a class="dropdown-item" href="<?php echo base_url("users/update_form/$user->id"); ?>"><i
                                class="fa fa-user fa-lg"></i> Profil</a></li>
                <li><a class="dropdown-item" href="<?php echo base_url("logout"); ?>"><i
                                class="fa fa-sign-out fa-lg"></i> Çıkış</a></li>
            </ul>
        </li>
    </ul>
</header>