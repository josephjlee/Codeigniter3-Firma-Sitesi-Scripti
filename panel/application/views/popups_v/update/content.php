            ...
            <div class="widget-body">
                <form action="<?php echo base_url("popups/update/$item->id"); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="m-0" id="summernote" data-plugin="summernote" data-options="{height: 250}"><?php echo isset($form_error) ? set_value("description") : $item->description; ?></textarea>
                    </div>
