...
//$bul = resimbul($id, 'resim', 'urun_resimleri'); unlink($bul);
function resimbul($id, $sutunadi, $tablo)
{
    $ci =& get_instance();
    $sonuc = $ci->db->select($sutunadi)->from($tablo)->where('id', $id)->get()->row();
    return $sonuc->$sutunadi;
}
...
function get_settings()
{
    ...
    if ($t->session->userdata("settings")) {
        ...
        if (!$settings) {
            ...
            $settings->company_name = "Lütfen Ayarlarınızı Güncelleyin";
